  ...
  return (
    <Container>
      <Content>
        ...
        <Row>
          <Button label="C" variant="secondary" onClick={handleOnClear}/>       
          <Button label="/" variant="secondary" onClick={handleDivNumbers}/>
          <Button label="x" variant="secondary" onClick={handleMultNumbers}/>
        </Row>
        ...
        <Row>
          ...
          <Button label="." variant="secondary" onClick={() => handleAddNumber('.')}/>        
        </Row>
